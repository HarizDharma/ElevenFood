        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <img src="<?php echo e(url('images/navbar.png')); ?>" alt="">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            ...
                            ?>
                            <a class="nav-link" href="<?php echo e(url('check_out')); ?>">
                                <i class="fa fa-shopping-cart"></i>
                                <?php if(!empty($notif)): ?>
                                    <span class="badge badge-primary"><?php echo e($notif); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
...
<?php /**PATH C:\Users\Krypton\Desktop\blog\resources\views/layouts/app.blade.php ENDPATH**/ ?>